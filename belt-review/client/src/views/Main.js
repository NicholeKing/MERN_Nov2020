                ...
                </tr>
                {
                    ...
                    creatures.map((creat, i) => {
                        return <tr>
                            ...
                            <td><button onClick={() => removeCreature(creat._id)} className="btn btn-danger">Remove</button>&nbsp;<a href={`http://localhost:3000/creatures/update/${creat._id}`} className="btn btn-warning">Update</a></td>
                        </tr>
                    }) : ""
                }
            </table>
